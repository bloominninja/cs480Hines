...
int main(int argc, char **argv)
   ...
   applyPhysics(paddle1.shape,paddle1.body,0,1,board_x-(.25*board_x),500);
   ...
   applyPhysics(paddle2.shape,paddle2.body,0,1,(.25*board_x)-board_x,500);
	dynamicsWorld->addRigidBody(paddle2.body, COL_PADDLE, paddleColl);
	paddle2.body->setRestitution(.2);
	
	
	//create Bound Wall
   		physicsCube.dim=btVector3(board_z,.3,.1);
...
physicsCube.dim=btVector3(0, 0, 0);
